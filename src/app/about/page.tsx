  ...
  return (
    <div>
      ...
      <section className="mb-10">
        <h2 className="text-lg font-semibold mb-3">홍길동</h2>
        <p className="text-muted leading-relaxed">
          안녕하세요! 웹 개발에 열정을 가진 소프트웨어 엔지니어입니다.
          사용자 경험을 개선하고 깔끔한 코드를 작성하는 것을 좋아합니다.
        ...
        <ul className="space-y-6">
          <li>
            ...
            <p className="text-sm text-muted mt-1">
              Next.js와 Tailwind CSS를 활용한 개인 블로그입니다.
              마크다운 기반의 포스트 작성과 정적 사이트 생성을 지원합니다.
            </p>
            <div className="flex gap-2 mt-2">
              <span className="text-xs px-2 py-0.5 bg-border rounded">Next.js</span>
              <span className="text-xs px-2 py-0.5 bg-border rounded">TypeScript</span>
              <span className="text-xs px-2 py-0.5 bg-border rounded">Tailwind CSS</span>
            </div>
          </li>
          <li>
            ...
            <div className="flex gap-2 mt-2">
              <span className="text-xs px-2 py-0.5 bg-border rounded">React</span>
              <span className="text-xs px-2 py-0.5 bg-border rounded">Node.js</span>
              <span className="text-xs px-2 py-0.5 bg-border rounded">MongoDB</span>
            </div>
          </li>
          <li>
            <h3 className="font-medium">날씨 대시보드</h3>
            <p className="text-sm text-muted mt-1">
              외부 API를 활용한 날씨 정보 대시보드입니다.
              위치 기반 검색과 주간 예보 기능을 제공합니다.
            </p>
            <div className="flex gap-2 mt-2">
              <span className="text-xs px-2 py-0.5 bg-border rounded">React</span>
              <span className="text-xs px-2 py-0.5 bg-border rounded">REST API</span>
              <span className="text-xs px-2 py-0.5 bg-border rounded">Chart.js</span>
            </div>
          </li>
        </ul>
      </section>
